"""
Django settings for adrian_test_45132 project.
...
ROOT_URLCONF = 'adrian_test_45132.urls'
...
WSGI_APPLICATION = 'adrian_test_45132.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "adrian_test_45132 API",
    "DESCRIPTION": "API documentation for adrian_test_45132 App",
    "VERSION": "v1",
}
